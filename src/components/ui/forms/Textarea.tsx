            ...
            <div className="w-full">
                ...
                <div className="relative group">
                    ...
                    <textarea
                        ref={ref}
                        className={cn(
                            "w-full bg-[#0A0E1A]/80 backdrop-blur-md border border-slate-700/50 text-white text-sm font-medium rounded-2xl py-3.5 outline-none transition-colors duration-300 placeholder:text-slate-600 resize-none",
                            "hover:border-amber-500/30 hover:bg-[#0A0E1A]",
                            "focus:ring-4 focus:ring-amber-500/10 focus:border-amber-500/50 focus:bg-[#0A0E1A] focus:shadow-lg",
                            icon ? "pl-11" : "pl-5",
                            "pr-5",
