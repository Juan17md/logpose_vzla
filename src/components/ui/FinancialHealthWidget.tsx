...
export default function FinancialHealthWidget() {
    ...
    return (
        <div className="bg-slate-900/50 backdrop-blur-md p-5 rounded-3xl border border-slate-700/50 shadow-lg relative overflow-hidden group transition-all hover:bg-slate-900/70 hover:border-slate-600">
