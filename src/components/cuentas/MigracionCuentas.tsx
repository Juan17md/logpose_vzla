            ...
            <div className="text-center">
                ...
                <div className="flex flex-col gap-3">
                    <button
                        ...
                        disabled={migrando}
                        className="w-full px-6 py-3 bg-violet-600 hover:bg-violet-500 text-white font-bold rounded-xl transition-colors shadow-lg disabled:opacity-50 flex items-center justify-center gap-2"
                    >
                        {migrando ? (
