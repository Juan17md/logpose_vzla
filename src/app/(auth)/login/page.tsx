...
import { FiMail, FiLock, FiArrowRight, FiEye, FiEyeOff, FiPieChart, FiTrendingUp } from "react-icons/fi";
    ...
    return (
        <>
            ...
            <div className="absolute inset-0 z-0 pointer-events-none">
                ...
                <div className="absolute -top-40 -left-40 w-[600px] h-[600px] bg-[#F59E0B]/10 rounded-full blur-[120px] mix-blend-screen animate-pulse" style={{ animationDuration: '8s' }}></div>
                <div className="absolute top-1/3 right-[-150px] w-[700px] h-[700px] bg-[#8B5CF6]/10 rounded-full blur-[140px] mix-blend-screen animate-pulse" style={{ animationDuration: '12s' }}></div>
                <div className="absolute -bottom-40 left-1/4 w-[500px] h-[500px] bg-[#1E3A8A]/20 rounded-full blur-[100px]"></div>
            ...
            <div className="hidden lg:flex w-1/2 relative items-center justify-center z-10">
                <div className="flex flex-col items-center justify-center p-12 text-center max-w-lg">
                    <div className="relative mb-8 group-logo">
                        ...
                        <Logo variant="map" width={280} height={280} className="drop-shadow-[0_0_40px_rgba(245,158,11,0.25)] hover:scale-105 transition-all duration-700 ease-out" />
                    </div>
                    ...
                    <p className="text-slate-300 text-lg mx-auto leading-relaxed max-w-md">
                        Navegando el Grand Line de tus finanzas personales con precisión inquebrantable.
                    </p>
                    ...
                    <div className="mt-16 grid grid-cols-1 gap-5 w-full">
                        <div className="group-card-1 opacity-0 translate-y-4 animate-fade-in-up">
                            <div className="p-5 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.4)] hover:bg-white/10 hover:border-white/20 transition-all duration-500 flex gap-4 items-center relative overflow-hidden">
                                ...
                                <div>
                                    <p className="text-white font-semibold tracking-wide group-hover:text-[#FBBF24] transition-colors">Análisis Premium</p>
                                    <p className="text-slate-400 text-sm">Visualiza tu progreso financiero</p>
                                </div>
                            </div>
                        </div>
                        <div className="group-card-2 opacity-0 translate-y-4 animate-fade-in-up" style={{ animationDelay: '150ms' }}>
                            <div className="p-5 rounded-2xl bg-white/5 backdrop-blur-xl border border-white/10 shadow-[0_8px_32px_0_rgba(0,0,0,0.4)] hover:bg-white/10 hover:border-white/20 transition-all duration-500 flex gap-4 items-center relative overflow-hidden">
                                ...
                                <div>
                                    <p className="text-white font-semibold tracking-wide group-hover:text-[#A78BFA] transition-colors">Control Total</p>
                                    <p className="text-slate-400 text-sm">Ahorros y deudas en un solo lugar</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-6 sm:p-12 relative z-10">
                <div className="w-full max-w-md">
                    ...
                    <div className="bg-[#1E293B]/30 backdrop-blur-2xl border border-white/10 p-8 sm:p-10 rounded-3xl shadow-[0_8px_32px_0_rgba(0,0,0,0.6)] relative overflow-hidden form-card opacity-0 translate-y-4 animate-fade-in-up" style={{ animationDelay: '200ms', animationFillMode: 'forwards' }}>
                        ...
                        <div className="text-center lg:text-left mb-8 relative z-10">
                            <h1 className="text-3xl sm:text-4xl font-bold text-white mb-2 tracking-tight">
                                Bienvenido<span className="text-[#FBBF24]">.</span>
                            </h1>
                            <p className="text-slate-400">Ingresa a tu control financiero</p>
                        </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 relative z-10">
                            ...
                            <div className="opacity-0 translate-y-2 animate-fade-in-up" style={{ animationDelay: '500ms', animationFillMode: 'forwards' }}>
                                <button
                                    type="submit"
                                    disabled={loading}
                        ...
                        <div className="relative my-8 opacity-0 animate-fade-in-up" style={{ animationDelay: '550ms', animationFillMode: 'forwards' }}>
                            <div className="absolute inset-0 flex items-center">
                                <div className="w-full border-t border-white/10"></div>
                            </div>
                            <div className="relative flex justify-center text-sm">
                                <span className="px-4 bg-[#0F172A] text-slate-500 backdrop-blur-sm">o continúa con</span>
                            </div>
                        </div>
                        ...
                        <div className="opacity-0 translate-y-2 animate-fade-in-up" style={{ animationDelay: '600ms', animationFillMode: 'forwards' }}>
                            <button
                                ...
                                disabled={loading}
                                type="button"
                                className="w-full group btn-google relative bg-white/[0.03] hover:bg-white/[0.08] text-white font-medium py-3.5 px-6 rounded-2xl transition-all duration-300 flex items-center justify-center gap-3 disabled:opacity-70 disabled:cursor-not-allowed border border-white/[0.08] hover:border-white/[0.15] hover:shadow-[0_4px_20px_rgba(0,0,0,0.3)]"
                            >
                                <FcGoogle size={22} className="shrink-0 group-hover:scale-110 transition-transform duration-300" />
                                <span className="group-hover:text-white transition-colors">Continuar con Google</span>
                            </button>
                        </div>

                        <p className="mt-8 text-center text-sm text-slate-400 relative z-10 opacity-0 animate-fade-in-up" style={{ animationDelay: '650ms', animationFillMode: 'forwards' }}>
                            ¿No tienes una cuenta?{" "}
                            <Link href="/register" className="text-[#FBBF24] hover:text-[#FCD34D] font-semibold hover:underline transition-all duration-200 ml-1 relative inline-block">
                                Regístrate aquí
                    ...
                    {/* Footer */}
                    <p className="text-center text-xs text-slate-600 mt-6 hidden lg:block opacity-0 animate-fade-in-up" style={{ animationDelay: '700ms', animationFillMode: 'forwards' }}>
