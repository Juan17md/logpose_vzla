...
import { FiAlertTriangle, FiAward, FiArrowLeft, FiBookOpen, FiCheckCircle, FiDollarSign, FiFileText, FiGlobe, FiHeadphones, FiLock, FiServer, FiShield, FiShieldOff, FiUserCheck, FiUsers, FiXCircle } from "react-icons/fi";
...
const secciones = [
  ...
  {
    icon: <FiGlobe />,
    titulo: "6. Uso del Asistente IA (Nami)",
    contenido:
  ...
  {
    icon: <FiDollarSign />,
    titulo: "7. Uso de Criptomonedas (USDT)",
    contenido:
  ...
  {
    icon: <FiServer />,
    titulo: "9. Disponibilidad, Suspensión y Fuerza Mayor",
    contenido:
